...
\fancyfoot[L]{\small Universidad del Valle de Guatemala}
...
Las demás categorías se excluyen para reproducir exactamente la definición de
serie empleada en el Laboratorio 1. Esta decisión mantiene constante el
universo de personas, la cobertura temporal y la base de comparación con los
...
La rejilla de la Tabla~\ref{tab:configuraciones} es reducida a propósito. Se llegó a ese tamaño
...
\begin{enumerate}
  \item Se ajustaron ocho candidatos de la rejilla final, cuatro por serie,
  y se documentaron dos diseños adicionales evaluados en ambas series. El
  tuneo fue cronológico y no utilizó el conjunto de prueba.
...
\begin{enumerate}[label={[\arabic*]}]
  ...
  \item Universidad del Valle de Guatemala (2026).
