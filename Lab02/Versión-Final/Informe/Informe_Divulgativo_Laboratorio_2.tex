...
\begin{enumerate}
  ...
  \item Se compararon cuatro variantes de LSTM por cada serie.
...
\callout{Teal}{%
\textbf{Mensaje final.} Estos modelos son una herramienta de apoyo, no un
reemplazo del criterio institucional ni de los datos más recientes. Para las
dos series analizadas, la LSTM sin características adicionales fue la opción
más efectiva.
}
